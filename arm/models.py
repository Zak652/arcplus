...
class Asset(Base):
	...
	category = Column(Integer, ForeignKey('asset_categories.id'), nullable = False)
	_type = Column(Integer, ForeignKey('asset_types.id'), nullable = False)
	_model = Column(Integer, ForeignKey('asset_models.id'), nullable = True)
	status = Column(Integer, ForeignKey('asset_status.id'), nullable = False)
